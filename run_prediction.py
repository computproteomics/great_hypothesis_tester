...
RT_RESULT_FILE = './results/{}_results/{}_irt_results.csv'.format(QUERY_NAME, QUERY_NAME)
FRAG_RESULT_FILE = './results/{}_results/{}_fragmentation_results.csv'.format(QUERY_NAME, QUERY_NAME)
